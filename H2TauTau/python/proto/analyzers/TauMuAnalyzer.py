...
class TauMuAnalyzer(DiLeptonAnalyzer):
    ...
    def bestDiLepton(self, diLeptons):
        ...
        least_iso_highest_pt = lambda dl: (dl.leg1().relIsoR(R=0.4, dBetaFactor=0.5, allCharged=False), -dl.leg1().pt(), -dl.leg2().tauID("byIsolationMVArun2v1DBoldDMwLTraw"), -dl.leg2().pt())
